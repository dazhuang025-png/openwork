...
export default function DashboardView(props: DashboardViewProps) {
  ...
  const navItem = (tKey: DashboardTab, label: string, icon: any) => {
    const active = () => props.tab === tKey;
    return (
      <button
    ...
    <div class="flex h-screen bg-zinc-950 text-white overflow-hidden">
      <aside class="w-64 border-r border-zinc-800 p-6 hidden md:flex flex-col justify-between bg-zinc-950">
        <div>
          ...
          <nav class="space-y-1">
            {navItem("home", t("dashboard.nav.home"), <Command size={18} />)}
            ...
            {navItem("mcp", t("dashboard.nav.mcp"), <Server size={18} />)}
        ...
        <div class="space-y-4">
          <div class="px-3 py-3 rounded-xl bg-zinc-900/50 border border-zinc-800">
            <div class="flex items-center gap-2 text-xs font-medium text-zinc-400 mb-2">
              ...
              {props.mode === "host" ? t("dashboard.mode.local") : t("dashboard.mode.client")}
            </div>
            <div class="flex items-center gap-2">
              ...
              >
                {props.clientConnected ? t("dashboard.status.connected") : t("dashboard.status.disconnected")}
              </span>
            </div>
                      ...
                      {(tpl) => (
                        ...
                        >
                          ...
                          <p class="text-sm text-zinc-500">
                            {tpl.description || t("dashboard.run_workflow")}
                          </p>
                        </button>
                      )}
                    </For>
